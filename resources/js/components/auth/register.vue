            ...
            <div class="card card-login mx-auto mt-5">
                ...
                <div class="card-body">
                    <form @submit.prevent="signup">
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="email" id="inputEmailds" class="form-control" placeholder="Email address"  autofocus="autofocus"  v-model="form.email">
                                <small class="text-danger" v-if="errors.email"> {{ errors.email[0] }} </small>
                                <label for="inputEmailds">Email address</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-label-group">
